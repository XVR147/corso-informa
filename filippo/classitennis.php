...
class soci{
      ...
      public function getSoci(){
        $richiesta="SELECT * FROM `ct_soci` WHERE `stato`=0";
      ...
      <tbody>';
       foreach($elencosoci as $socii){
         echo '<tr><th scope="row">'.$socii["id"].'</th>
               ...
               <td><img onclick="update('.$socii["id"].",'".$socii["nome"]."','".$socii["cognome"]."','".$socii["data_nascita"]."','".$socii["codice_fiscale"]."'".')"src="https://img.icons8.com/ios-glyphs/30/000000/design.png/"> <img src="https://img.icons8.com/wired/32/000000/filled-trash.png/"></td>
              </tr>';
